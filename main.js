...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Save2.Msg":{"args":[],"tags":{"JsonRead":["Ports.JsonPortData"],"JsonSelected":["String"]}},"Main.Msg":{"args":[],"tags":{"Save2":["Save2.Msg"]}}},"aliases":{"Ports.JsonPortData":{"args":[],"type":"{ contents : String, filename : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
